...
export default function MainApp() {
  ...
  // Restore state from sessionStorage on initial load if available
  useEffect(() => {
    try {
  ...
  // Step 1: User submits Enriched Description from IntakePage Step 2
  ...
  // User submits answers on ClarifyPage
  ...
  // Re-check status if analysis takes > 90s
